...
public class IntroductionPage01Fragment extends Fragment implements Animation.AnimationListener{
    ...
    public static IntroductionPage01Fragment newInstance() {
        IntroductionPage01Fragment fragment = new IntroductionPage01Fragment();
        return fragment;
    }

    public IntroductionPage01Fragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        image.setImageResource(R.drawable.cube_jhonn);
        ...
        introduction_page_label.setText(DisplayColors.twoColors(getString(R.string.i_am), getString(R.string.veteran_programmer)));
